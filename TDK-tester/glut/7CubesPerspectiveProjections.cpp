...
void drawShape()
{
	...
	for (int k = 0; k < 5;)
	{
		for (int j = 0; j < 5;)
		{
			for (int i = 0; i < 5;)
			{
				GLfloat vertA[3] = { 0.4 + i, 0.4 + j, 0.4 + k };
				GLfloat vertB[3] = { -0.4 + i, 0.4 + j, 0.4 + k };
				GLfloat vertC[3] = { -0.4 + i,-0.4 + j, 0.4 + k };
				GLfloat vertD[3] = { 0.4 + i,-0.4 + j, 0.4 + k };
				GLfloat vertE[3] = { 0.4 + i, 0.4 + j,-0.4 + k };
				GLfloat vertF[3] = { -0.4 + i, 0.4 + j,-0.4 + k };
				GLfloat vertG[3] = { -0.4 + i,-0.4 + j,-0.4 + k };
				GLfloat vertH[3] = { 0.4 + i,-0.4 + j,-0.4 + k };

				glColor3f(1.0 - i / n, 1.0-j/n, 0.0+k/n);
				glVertex3fv(vertA);
				glVertex3fv(vertB);
				glVertex3fv(vertC);
				glVertex3fv(vertD);
				/* back => FEHG red */
				glColor3f(1.0 - i / n, 0.0+j/n, 0.0+k/n);
				glVertex3fv(vertF);
				glVertex3fv(vertE);
				glVertex3fv(vertH);
				glVertex3fv(vertG);
				/* right => EADH green */
				glColor3f(0.0+j/n, 1.0 - i / n, 0.0+k/n);
				glVertex3fv(vertE);
				glVertex3fv(vertA);
				glVertex3fv(vertD);
				glVertex3fv(vertH);
				/* left => BFGC blue */
				glColor3f(0.0+k/n, 0.0+j/n, 1.0 - i / n);
				glVertex3fv(vertB);
				glVertex3fv(vertF);
				glVertex3fv(vertG);
				glVertex3fv(vertC);
				/* top => EFBA turquoise */
				glColor3f(0.0+j/n, 1.0 - i / n, 1.0 - k/n);
				glVertex3fv(vertE);
				glVertex3fv(vertF);
				glVertex3fv(vertB);
				glVertex3fv(vertA);
				/* bottom => DCGH pink */
				glColor3f(1.0 - i / n, 0.0+j/n, 1.0-k/n);
				glVertex3fv(vertD);
				glVertex3fv(vertC);
				glVertex3fv(vertG);
				glVertex3fv(vertH);
	...
	for (int k = 0; k < 5;)
	{
		for (int j = 0; j < 5;)
		{
			for (int i = 0; i < 5;)
			{
				GLfloat vertA[3] = { 0.2 - i, 0.2 - j, 0.2 - k };
				GLfloat vertB[3] = { -0.2 - i, 0.2 - j, 0.2 - k };
				GLfloat vertC[3] = { -0.2 - i,-0.2 - j, 0.2 - k };
				GLfloat vertD[3] = { 0.2 - i,-0.2 - j, 0.2 - k };
				GLfloat vertE[3] = { 0.2 - i, 0.2 - j,-0.2 - k };
				GLfloat vertF[3] = { -0.2 - i, 0.2 - j,-0.2 - k };
				GLfloat vertG[3] = { -0.2 - i,-0.2 - j,-0.2 - k };
				GLfloat vertH[3] = { 0.2 - i,-0.2 - j,-0.2 - k };
