...
void displayInit(void) {
	...
	glEnable(GL_DEPTH_TEST);				//applying depth to the scene
...
void displayEye(void) {
	...
	gluLookAt(Ex + ecX, Ey+ecY, Ez + ecZ, ecX, ecY, ecZ, 0, Cos(ph), 0);
}
...
// This is called whenever we need to redraw the display
