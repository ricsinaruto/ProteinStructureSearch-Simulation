...
#define DEF_TEMP			(int)2000/(ITER_NUMBER+2)///valamilyen választási paraméter, ennyiszer futhat max a while ciklus
...
#define DEF_SUGAR			0.000006			///random generáláshoz paraméter
